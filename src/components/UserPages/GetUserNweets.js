...
const GetUserNweets = ({ strangerNweet, userObj }) => {
  ...
  useEffect(() => {
    ...
    let second = Math.floor((now - strangerNweet.createdAt[0]) / 1000);
    if (second > 2592000) {
    ...
    const userId = strangerNweet.userEmail.split("@");
    setUserEmail(userId);
      ...
      <div className="nweet">
        ...
        <div className="nweet_right">
          <div className="nweet_right_top">
            <div className="nweet_info">
              <span className="nweet_info_displayName">
                {strangerNweet.displayName}
              </span>
              <span className="nweet_info_userId">{userEmail[0]}</span>
          ...
          <div className="nweet_right_center">
            <h4 className="nweet_content">{strangerNweet.text}</h4>
            {isHash && (
              <span className="nweet_hashtag">{strangerNweet.hashTag}</span>
            )}
          ...
          <div className="nweet_right_bottom">
            <div className="nweet_right_bottom_like" onClick={onLikeBtnClick}>
              ...
              <span>{strangerNweet.like.length}</span>
            </div>
            <div
            ...
            >
              ...
              <span>{strangerNweet.reNweet.length}</span>
            </div>
            <div
              className="nweet_right_bottom_follow"
