      ...
      hashRef
        ...
        .onSnapshot((snapshot) => {
          if (snapshot.exists) {
            ...
            const newHashTag = snapshot.docs.map((doc) => ({
              id: doc.id,
              ...doc.data(),
            }));
            setTrend(newHashTag);
          ...
          <div onClick={onSearchClick} className="aside_left_search">
            ...
            >
              ...
              <form
                ...
                className="aside_left_search_center"
              >
                <input
          ...
          <div className="aside_left_trend">
            <div className="aside_left_trend_wrapper">
              ...
              <div className="aside_left_trend_center">
                {trend.map((data) => (
                  <AsideTrend key={data.id} hashTagArray={data} />
                ))}
              </div>
              <div className="aside_left_trend_bot">더보기임</div>
            </div>
          </div>
